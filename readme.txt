    ...
    mjdb_14000_data_cleaned.csv is cleaned on Sun Dec 13 21:26:38 2020, by cleaning_mjdb_v1.py

    The data was downloaded from meijao database, including 14271 samples(rows).

    13 variants(columns) had been selected and cleaned.
